...
public class Main {
    ...
    static final String URL_OpenWeatherMap_weather_London_uk =
            "http://api.openweathermap.org/data/2.5/weather?q=" +
                    "London,uk" +
                    "&appid=55237a65b62250166540d4f210729e08" +
                    "&units=metric";

    public static void main(String[] args) {

        WeatherFactory weatherFactory = WeatherFactory.getInstance();
        Weather weather = weatherFactory.getWeather("01d", new WeatherArguments(1, 2, 3, 4, "opis", "Lądek"));
        SQLConnector con = new SQLConnector();
        //con.AddRecordToDB(weather, "Kato");
        /// con.getArchiveData("Kato");
